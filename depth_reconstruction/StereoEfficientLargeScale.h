...
public:
	...
	void process(cv::Mat& leftim, cv::Mat& rightim, cv::Mat& leftdisp, cv::Mat& rightdisp, int border);
	void process(cv::Mat& leftim, cv::Mat& rightim, cv::Mat& leftdisp, int border);
